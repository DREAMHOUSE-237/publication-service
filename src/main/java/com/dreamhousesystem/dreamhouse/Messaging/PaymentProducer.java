...
public class PaymentProducer {
    ...
    public void sendPaymentRequest(String proprietaireEmail, String description, Double prix, String numeroPaiement) {
        //Double montant=prix*0.005;
        PaymentRequestMessage message = new PaymentRequestMessage(proprietaireEmail, description, prix, numeroPaiement);
